        ...
        <div className="flex flex-col lg:flex-row  justify-center items-center py-[30px]">
          ...
          <div className="w-full md:w-auto flex flex-col">
            ...
            <div className="font-lora font-bold py-4 text-justify">
              <p>
                Software Engineer with 1+ year of experience. Completed B.sc in
                Computer Science and Engineering from Gono Bishwabidyalay. Able
                to complete any kind of task under pressure.
